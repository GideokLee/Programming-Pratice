package com.ssafy.comp_03.aidl_activity
...
import com.ssafy.comp_03.aidl_activity.aidl.IMyAidlInterface
import com.ssafy.comp_03.aidl_activity.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener {
            binding.textview.text =
                MyServiceConnection.myService.currentTime
        }
    }
    ...
    override fun onStart() {
        ...
        var target = ComponentName(
            "com.ssafy.comp_03.aidl_service",
            "com.ssafy.comp_03.aidl_service.AIDLService")
...
object MyServiceConnection : ServiceConnection {
    ...
    // 바인딩한 서비스 객체
    lateinit var myService: IMyAidlInterface

 ...
 */
package com.ssafy.comp_03.aidl_activity.aidl;
...
public interface IMyAidlInterface extends android.os.IInterface
{
  ...
  public static class Default implements IMyAidlInterface
  {
    /**
         ...
         */
    @Override public String getCurrentTime() throws android.os.RemoteException
    {
      return null;
    }
    @Override
  ...
  {
    private static final String DESCRIPTOR = "com.ssafy.comp_03.aidl_service.IMyAidlInterface";
    ...
    /**
     * Cast an IBinder object into an com.ssafy.comp_03.aidl_service.IMyAidlInterface interface,
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_getCurrentTime:
        {
          ...
          String _result = this.getCurrentTime();
    ...
    private static class Proxy implements IMyAidlInterface
    {
      ...
      @Override public String getCurrentTime() throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_getCurrentTime, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getCurrentTime();
          }
  ...
  /**
       ...
       * and return values in AIDL.
       */
  public String getCurrentTime() throws android.os.RemoteException;
}

...
class PlacesAPIActivity : AppCompatActivity(), OnMapReadyCallback, PlacesListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_places_apiactivity)
        ...
        if (checkPermission()) { // 1. 위치 퍼미션을 가지고 있는지 확인
            ...
            val permissionListener = object : PermissionListener {
                ...
                override fun onPermissionDenied(deniedPermissions: MutableList<String>?) {
                    Toast.makeText(this@PlacesAPIActivity,
                        "위치 권한이 거부되었습니다.",
...
//        mMap!!.moveCamera(cameraUpdate)
    ...
    /** places 검색 추가.**/
    private var exMarker = arrayListOf<Marker>()
    ...
    override fun onPlacesSuccess(places: List<Place>?) {
        runOnUiThread {
            ...
            hashSet.addAll(exMarker)
            exMarker.clear()
            exMarker.addAll(hashSet)
        }

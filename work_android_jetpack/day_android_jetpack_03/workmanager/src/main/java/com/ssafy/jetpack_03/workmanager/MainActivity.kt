package com.ssafy.jetpack_03.workmanager

import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import androidx.work.*
import com.ssafy.jetpack_03.workmanager.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnStartSimpleWorker.setOnClickListener {
        ...
        binding.btnCancelSimpleWorker.setOnClickListener {
            val workManager = WorkManager.getInstance(this)
